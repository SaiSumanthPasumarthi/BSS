...
.modal-dialog {
 ...
 /* table {border-collapse:collapse; table-layout:fixed; width:1100px;}  */
       /* table td { width:300px; word-wrap:break-word;}    */  
   .datatable td span{
    max-width: 400px;
    display: block;
    overflow: hidden;
                   ...
                   <div class="panel-header bg-light">
                    ...
                    <div class="panel-content" align="center">
                      ...
                      <div class="col-sm-3">
                      		...
                      		<form:select path="ticketFor" id="ttForID" style="width: 200px; " class="form-control form-white select">
                    ...
                    <div class="row" style="display:none">
                      <div class="col-sm-3">
                      		...
                      		<input type="text" name="ttNumber" id="ttNumberID" class="form-control form-white" maxlength="50" style="width: 200px; " placeholder="Enter TT Number">
                        ...
                        <div class="col-sm-3">
                      		...
                      		<input type="text" name="contactLandline" id="landlineNoID" class="form-control form-white" style="width: 200px; " maxlength="50" placeholder="Enter Landline Number">
                         ...
                         <div class="col-sm-3">
                      		...
                      		<input type="text" name="contactMobile" id="MobileNoID" class="form-control form-white" style="width: 200px; " maxlength="15" placeholder="Enter Mobile Number">
						...
						<label class="control-label">Priority</label> 														   
							<form:select path="ticketPriority" id="priorityID" style="width: 200px; " class="form-control form-white">
	                  ...
	                  <div class="form-group">
	                     	...
	                     	<input type="text" name="cafNo" id="cafNoIID" style="width: 200px; " class="form-control form-white" maxlength="20" placeholder="Enter Account No">
	                   	</div>
                       </div>
					  </div>
					...
					<div class="row" >
						...
						<label class="control-label">Closure Reason</label> 														   
							<form:select path="actualIssue" id="actualIssueID" style="width: 200px; " class="form-control form-white">
						 ...
						 <div class="col-sm-3" >
                      		...
                      		<input type="button" id="searchID" value="Get All Pending Trouble Tickets" class="btn btn-embossed btn-primary" />
...
// 					 					html = html+'<td></td>';
// 					 				}
					 				html = html+'<td>'+obj.ticketDesc+'</td>';
