		...
		<div class="main-content">
			...
			<div class="page-content page-width">
				<div class="page-title">
					...
					<!-- Create Cpe Order -->
			<form action="./uploadCpeStockFile" id="cpeStockUploadFormId" method="POST" enctype="multipart/form-data">
										...
										<div class="panel">
											...
											<div class="panel-content">
												...
												<div style="clear:both;"></div>
													...
													<input  type="file" name="cpeStockFile" required="required"> 
													</div>
													</div>
												...
												<div class="col-sm-6"><button class="btn btn-embossed btn-primary" type="Button" id="cpeStockUpload">Submit</button></div>
												<div class="col-sm-6"><a class="btn btn-embossed btn-primary" href="./downloadExcelFile"> Download Template</a></div>
									            </div>
											</div>
										</div>
									</div>
