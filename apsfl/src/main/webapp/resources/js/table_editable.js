$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" class="form-control form-white small" value="' + aData[0] + '">';
            jqTds[1].innerHTML = '<input type="text" class="form-control form-white small" value="' + aData[1] + '">';
            jqTds[2].innerHTML = '<input type="text" class="form-control form-white small" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<input type="text" class="form-control form-white small" value="' + aData[3] + '">';
        ...
        jQuery('#table-edit_wrapper .dataTables_filter input').addClass("form-control form-white medium"); // modify table search input
        jQuery('#table-edit_wrapper .dataTables_length select').addClass("form-control form-white xsmall"); // modify table per page dropdown
