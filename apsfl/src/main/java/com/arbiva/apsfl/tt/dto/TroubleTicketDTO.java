...
import com.arbiva.apsfl.coms.dto.Customer.UsersDataSearchParams;
...
public class TroubleTicketDTO implements Serializable {
	...
	public enum UsersDataSearchParams{
		...
		COLUMN_0("ticketno"),COLUMN_1("cafno"),COLUMN_2("issuetype"),COLUMN_3("issuename"),
		COLUMN_4("custname"),COLUMN_5("olt_id"),COLUMN_6("olt_portid"),COLUMN_7("olt_onuid"),COLUMN_8("createdon"),
		COLUMN_9("expclosedate"),COLUMN_10("modifiedon");
	...
	List<TroubleTicketDTO2> listOfTroubleTickets;
	
	public List<TroubleTicketDTO2> getListOfTroubleTickets() {
		return listOfTroubleTickets;
	}

	public void setListOfTroubleTickets(List<TroubleTicketDTO2> listOfTroubleTickets) {
