        ...
        $('.table-dynamic').each(function () {
            ...
            if ($(this).hasClass('filter-head')) {
                $('.filter-head thead th').each( function () {
                    ...
                    $(this).append( '<input type="text" onclick="stopPropagation(event);" class="form-control form-white" placeholder="Filter '+title+'" />' );
					//$(this).prepend( '<input type="text" onclick="stopPropagation(event);" class="form-control form-white" placeholder="Filter '+title+'" />' );  /* before title */
                });
            ...
            if ($(this).hasClass('filter-footer')) {
                $('.filter-footer tfoot th').each( function () {
                    ...
                    $(this).html( '<input type="text" class="form-control form-white" placeholder="Filter '+title+'" />' );
                });
                ...
                $(this).DataTable( {
                    initComplete: function () {
                        ...
                        api.columns().indexes().flatten().each( function ( i ) {
                            ...
                            var select = $('<select class="form-control form-white" data-placeholder="Select to filter"><option value=""></option></select>')
        ...
        $('.form-validation').each(function(){
            var formValidation = $(this).validate({
                ...
                highlight: function(element, errorClass, validClass) {
                    $(element).closest('.form-control form-white').addClass(errorClass).removeClass(validClass);
                },
                unhighlight: function(element, errorClass, validClass) {
                    $(element).closest('.form-control form-white').removeClass(errorClass).addClass(validClass);
                },
