        ...
        <div class="col-lg-12">
          <div class="panel main-panel">
                ...
                <div class="col-sm-12">
                  <div class="panel">
                    ...
                    <div class="panel-content">
                      ...
                      <a title="Please Enter Tenant Name" class="tooltip1" data-placement="top"><input type="text" id="name" name="name" value="${tenantVO.name}" class="form-control form-white" placeholder="Enter Name" maxlength="100" pattern="[a-zA-Z][a-zA-Z\s]*" ></a>
                    </div>
                  </div>
                 <div class="col-sm-4">
                    <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">PAN</label>
                           <input type="text" name="panNo" id="panNo" class="form-control form-white" placeholder="Enter PAN" value="${tenantVO.panNo}" maxlength="10" pattern="[A-Z]{5}\d{4}[A-Z]{1}"/>
                    </div>
                  </div>
                  <div class="col-md-4">
                          <div class="form-group">
                            <label class="form-label">Aadhar</label>
                            <input type="text" name="aadharCardNo" id="aadharCardNo" class="form-control form-white" value="${tenantVO.aadharCardNo}"/>
                          </div>
                        </div>					  
					  </div>
					 <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="panel">
                    ...
                    <div class="panel-content">
                     ...
                     <textarea name="address2" id="address2" class="form-control form-white" >${tenantVO.address1}</textarea>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Address</label>
						<textarea name="address2" id="address2" class="form-control form-white" >${tenantVO.address2}</textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                          <div class="form-group">
                            <label class="form-label">Locality</label>
                           <input type="text" name="locality" id="locality" class="form-control form-white" placeholder="Enter Locality" value="${tenantVO.locality}" />
                          </div>
                        </div>					  
					  </div>
					  <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Document <span style="color: red;">*</span></label>
                        ...
                        <select id="doclov" name="doclov" class="form-control form-white">
                  ...
                  <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <a title="Please Upload License" class="tooltip1"><input type="file" name="licenceId" id="licenceId" class="form-control form-white" placeholder="Attach License copy" /><c:if test="${not empty tenantDocumentsVO}"><span class="galleryImgs">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Document <span style="color: red;">*</span></label>
                        ...
                        <select id="doclov1" name="doclov1" class="form-control form-white"	>
						<option value="">Select Document </option>
						<c:forEach var="lovs" items="${lovsList}">
							<c:choose>
							<c:when
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Document <span style="color: red;">*</span></label>
                        ...
                        <select id="doclov2" name="doclov2" class="form-control form-white">
						<option value="">Select Document </option>
						<c:forEach var="lovs" items="${lovsList}">
							<c:choose>
							<c:when
			...
			<div class="row">
				...
				<div class="panel">
				<div class="panel-header bg-light">
                      <h3>Tenant Agreement with MSP</h3>
                    </div>
				<div class="panel-content">
              <form name="tenantAgmtForm"  action="<c:url value="/approveLmoMspAgreement"/>" method="post" id="lomAgreement_form" enctype="multipart/form-data">
			<!-- <form role="form" class="form-validation">  -->
			<div class="row">
                <div class="col-sm-12">
				<div class="panel">
				<div class="panel-header bg-light">
                      <h3>MSP Agreement with <strong>${tenantVO.name}</strong></h3>
                    </div>
				<div class="panel-content">
              ...
              <div class="row">                
                  <div class="col-sm-4">
							<div class="form-group">
                      <label class="control-label">MSP Name<span style="color: red;">*</span></label>
                      <input type="hidden" name="tenantId" id="tenantId" value="${tenantVO.tenantId}"/>
                      <input type="hidden" id="mspCode" name="mspCode" value="${tenantLMOMSPAgreementVO.mspCode}" />
                      <input type="hidden" id="lmoCode" name="lmoCode" value="${tenantLMOMSPAgreementVO.lmoCode}" />
				 ...
				 <div class="col-sm-4">
                            <div class="form-group">
								...
								<div class="option-group">
									<select id="region1" name="region" class="form-control form-white" disabled>
										<c:forEach var="region" items="${regionList}">
											<c:choose>
												<c:when test="${not empty tenantRegion  && region.regionName == tenantRegion}">
													<option value="${region.regionName}" selected>${region.regionName}</option>
												</c:when>
												<c:otherwise>
													<option value="${region.regionName}">${region.regionName}</option>
                      ...
                      <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Core Service<span style="color: red;">*</span></label>
                           <div class="option-group">
                              <select id="coreserviceCode" name="coreserviceCode" class="form-control form-white" >
						
						<c:forEach var="coreService" items="${selectedCoreServicesList}">
						<option value="">${coreService}</option>
						</c:forEach>
						</select>
                        </div>
                    </div>
                  ...
                  <div class="col-md-4">
                          <div class="form-group">
							...
							<input type="text" class="date-picker form-control form-white" readonly placeholder="Select a date..." name="agreementDate" id="agreementDate" value='<f:formatDate pattern="MM/dd/yyyy" value="${tenantLMOMSPAgreementVO.agreementDate}" />' />
                            
                          </div>
                        </div>
				 	<div class="col-md-4">
                          <div class="form-group">
                            <label class="form-label">Agreement From<span style="color: red;">*</span></label>
							<input type="text" class="date-picker form-control form-white"  placeholder="Select a date..." name="agreementFrom" id="agreementFrom"
							readonly value='<f:formatDate pattern="MM/dd/yyyy" value="${tenantLMOMSPAgreementVO.agrFDate}" />' />
                          </div>
                        </div>
						...
						<div class="col-md-4">
                          <div class="form-group">
							...
							<input type="text" class="date-picker form-control form-white" readonly placeholder="Select a date..." name="agreementTo" id="agreementTo"
																<c:if test="${empty tenantLMOMSPAgreementVO}"> value="12/31/9999" </c:if> value='<f:formatDate pattern="MM/dd/yyyy" value="${tenantLMOMSPAgreementVO.agreementTo}" />' />
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-white" placeholder="Enter Deposit Amount" name="depositAmount" id="depositAmount" value="${tenantLMOMSPAgreementVO.depositAmount}" readonly/>
                    </div>
					</div>
					<div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">LMO Wallet Amount<span style="color: red;">*</span></label>
                      <input type="text" class="form-control form-white" placeholder="Enter LMO WalletAmount" name="lmoWalletAmount" id="lmoWalletAmount" value="${tenantLMOMSPAgreementVO.lmoWalletAmount}" readonly />
                    </div>
					</div>
					<div class="col-sm-4"> 
                    <div class="form-group">
                      <label class="control-label">Upload Agreement</label>
					  <!-- <input type="file" class="form-control form-white" placeholder="Upload Agreement File" name="agreementCopy" id="agreementCopy" /> -->
																<c:if test="${not empty tenantLMOMSPAgreementVO}">
																	<a href="#"><img width="30" src="downloadFiles?path=${tenantLMOMSPAgreementVO.agreementDocRef}" /></a>
																</c:if>
                    </div>
					</div>
					</div>
					...
					<div align="right">
    				<button class="btn btn-embossed btn-success" type="submit" name="action" value="Approve" >Approve</button>
  				...
  				<!-- <div align="right">
   					<button type="submit" name="action" value="Approve" class="js-open-modal btn_green" >Approve</button>
...
<%-- <div id="popup1" class="modal-box">
  ...
  <div class="modal-body">
    <p><textarea name="reasons" id="reasons" cols="70" rows="3"></textarea></p>
  </div>
  <footer><button type="submit" name="action" value="Send Back" class="js-open-modal btn_green" >Submit</button></footer>
</div>
