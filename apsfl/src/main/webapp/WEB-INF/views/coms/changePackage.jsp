...
<form role="form" class="form-validation" name="Addpackagesform" id="Addpackagesform" action="#" method="post" enctype="multipart/form-data">
<div id="selectPackagesDiv">
	<div class="main-content" >
		<!-- BEGIN PAGE CONTENT -->
	<div class="page-content page-width">
		<div class="page-title">
			<h2>Change <strong> Base Package</strong></h2>
			<c:if test="${not empty message}"> <center id="comsErrorMsg" ><font color='green' size="3">${message}</font></center></c:if>
			<div class="breadcrumb-wrapper">
				<ol class="breadcrumb">
					<li><a href="./">Home</a></li>
					<li class="active">Change Base Package </li>
				</ol>
			</div>
		</div>
				...
				<div class="panel main-panel">
					<div class="panel-content main-panel-content">
							...
							<div class="row m-b-10">
								<div class="col-sm-12">
									<div id="productTableDivOneTime"><b>Existing Base Package</b>
										...
										<tbody>
											<c:forEach items="${currentProductList}" var="product" >
												<tr class="">
													...
													<!-- <td align="center"><input type="radio" name="radios"id="productCheckbox" class="productCheckbox2 changePkgRadio" /></td> -->
												</tr>
											</c:forEach>
										</tbody>
									</table>
							...
							<c:choose>
								...
								<div class="row m-b-10">
									<div class="col-sm-12">
										<div id="productTableDivOneTime"><b>New Base Packages</b>
								...
								<label id="productError" style="text-align: left;color: red;"></label>
									...
									&nbsp;
									<button class="btn btn-embossed btn-primary" type="button" id="changePackagesSubmitButton" >Submit</button>
								</div>
								</c:when>
								<c:otherwise>
